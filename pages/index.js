        ...
        <div className="container wrapper">
          <div className="header">
            <h1 className="header-title">
              Welcome to{" "}
              <span className="primary-header">Feldenkrais Ireland</span>, the
              association for{" "}
              <span className="italic-header">qualified practitioners </span>
              in Ireland.
            </h1>
              ...
              <div className="c-section">
                <div>
                  <p className="header-subtitle">
                    Feldenkrais Ireland was established in 2009 to help develop
                    awareness of the Feldenkrais Method in Ireland, and as a
                    central point of contact for Feldenkrais practitioners
                    around the country.
                    <br />
                    {/* <br />
